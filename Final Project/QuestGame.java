...
public class QuestGame {
    ...
    /* 2 */ {"Which of the following transport layer protocol is used to support electronic mail? ",
                ...
                "C"," TCP \n",
                "D"," UDP \n"," TCP \n"}, 
    /* 3 */ {"When signals are free to travel in both directions over a medium similutaneously, the transmission is considered______. ",
                "A"," File-Sharing \n",
                "B"," Full-Duplex \n",
                "C"," Peer-to-Peet \n",
                "D"," Cable Plant \n"," Full-Duplex \n"}, 
    ...
    /* 6 */ {"What huge San Jose based company is concidered the king of networks? ",
                "A"," STECH \n",
                "B"," Cisco \n",
                "C"," IBM \n",
                "D"," Symtec \n"," Cisco \n"},
